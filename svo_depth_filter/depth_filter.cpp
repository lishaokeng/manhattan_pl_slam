...
// Seed::Seed(vo::Feature* ftr, float depth_mean, float depth_min) :
...
//  * 添加一帧普通帧
// */
// void DepthFilter::addFrame(vo::Frame* frame)
// {
//   if(thread_ != NULL)
//   {
//     {
...
//  * 添加一帧关键帧
// */
// void DepthFilter::addKeyframe(vo::Frame* frame, double depth_mean, double depth_min)
// {
...
//  * @param frame 当前关键帧
// */
// void DepthFilter::initializeSeeds(vo::Frame* frame)
// {
...
//   // 种子批次计数
//   ++Seed::batch_counter;
//   std::for_each(frame->features_.begin(), frame->features_.end(), [&](const std::unique_ptr<vo::Feature>& ftr){
//     seeds_.push_back(Seed(ftr.get(), new_keyframe_mean_depth_, new_keyframe_min_depth_));
//   });

//   seeds_updating_halt_ = false;
// }

// void DepthFilter::removeKeyframe(vo::Frame* frame)
// {
//   seeds_updating_halt_ = true;
